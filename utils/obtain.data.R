...
path_to_data = "data"
path_to_JHU_data = "data/official/jhu_death_data_padded_210127.rds"
path_to_NYC_data = "data/official/NYC_deaths_210127.csv"
states_w_one_day_delay = c("CT", "DC","FL","MO","MS","SC", 'WY', 'HI')
