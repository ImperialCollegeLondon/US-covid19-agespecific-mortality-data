...
for x in urls[:-1]:
    ...
    if (cum_deaths_new > cum_deaths) and (urls.index(x) < len(urls)-1):
            ...
            daily_deaths = int(cum_deaths_new.replace(',','')) - int(max(cum_deaths_old1, cum_deaths_old2).replace(',',''))
...
if not os.access("data/{}/pennsylvania.json".format(day), os.F_OK):
    ...
    age_data = {"20-29": 0, "30-39": 0, "40-49": 0, "50-59": 0, "60-69": 0, "70-79": 0, "80-89": 0, "90-99": 0, "100+": 0}
